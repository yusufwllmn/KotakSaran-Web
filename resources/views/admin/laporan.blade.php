...
<div class="overflow-x-auto z-0 bg-white">
            ...
            <div class="modal-box w-full h-5/6 max-w-7xl bg-white z-0">
                <h3 class="font-bold text-[#6C757D] text-center text-2xl">Laporkan</h3>
                    ...
                    <textarea class="textarea textarea-bordered bordered-black border border-solid h-48 bg-white text-black" placeholder="Masukan Disini..."></textarea>
                    </div>
                    <label class="label bg-gray">
                        <span class="label-text text-lg text-gray">Tanggal :</span>
                    </label>
                    <input type="date" class="bg-[#d3d3d3] text-gray-700 h-12 input input-bordered w-full max-w-xs ">
                    <label class="label bg-gray">
                        <span class="label-text text-lg text-gray">Tujuan Laporan :</span>
                    </label>
                
                    <select class="select select-bordered border bordered-black border-solid bg-white w-full max-w-xs" id="subjek" value={subjek}>
